...
public class WaterSourcesInvestigation implements Serializable {
    ...
    private String devicePtx;
    private String devicePty;
    ...
    public String getDevicePtx() {
        return devicePtx;
    }

    public void setDevicePtx(String devicePtx) {
        this.devicePtx = devicePtx;
    }

    public String getDevicePty() {
        return devicePty;
    }

    public void setDevicePty(String devicePty) {
        this.devicePty = devicePty;
    }
